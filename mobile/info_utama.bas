...
Sub Globals
	...
	'Private m_booking = "m_booking" As String
...
Sub Activity_Create(FirstTime As Boolean)
	...
	Label7.Text=pencarian_nama.name
	Label8.Text=pencarian_nama.price
	Dim Job As HttpJob
	Job.Initialize("Jobcarinama", Me)
	Job.PostString("http://192.168.100.13/wisatasolsel/mobile/info_detail.php?id="&pencarian_nama.id,"")
End Sub
...
Sub detailNama
	...
	ExecuteRemoteQuery("SELECT*FROM object_point where id_package='"&pencarian_nama.id&"' ORDER BY object_point.no_urut ASC ","object")
