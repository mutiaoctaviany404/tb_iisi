...
views.get("listview1").vw.setWidth((int)((71d / 100 * height) - ((5d / 100 * width))));
views.get("listview1").vw.setTop((int)((35d / 100 * height)));
views.get("listview1").vw.setHeight((int)((72d / 100 * height) - ((35d / 100 * height))));
views.get("spinner1").vw.setLeft((int)((5d / 100 * width)));
views.get("spinner1").vw.setWidth((int)((70d / 100 * height) - ((5d / 100 * width))));
views.get("spinner1").vw.setTop((int)((23d / 100 * height)));
views.get("spinner1").vw.setHeight((int)((29d / 100 * height) - ((23d / 100 * height))));
views.get("spinner2").vw.setLeft((int)((5d / 100 * width)));
views.get("spinner2").vw.setWidth((int)((95d / 100 * width) - ((5d / 100 * width))));
views.get("spinner2").vw.setTop((int)((30d / 100 * height)));
views.get("spinner2").vw.setHeight((int)((37d / 100 * height) - ((30d / 100 * height))));
views.get("spinner3").vw.setLeft((int)((5d / 100 * width)));
views.get("spinner3").vw.setWidth((int)((95d / 100 * width) - ((5d / 100 * width))));
views.get("spinner3").vw.setTop((int)((38d / 100 * height)));
views.get("spinner3").vw.setHeight((int)((44d / 100 * height) - ((38d / 100 * height))));
