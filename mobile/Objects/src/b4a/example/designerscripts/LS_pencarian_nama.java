...
public class LS_pencarian_nama{
...
views.get("edittext1").vw.setLeft((int)((5d / 100 * width)));
views.get("edittext1").vw.setWidth((int)((95d / 100 * width) - ((5d / 100 * width))));
views.get("edittext1").vw.setTop((int)((18d / 100 * height)));
views.get("edittext1").vw.setHeight((int)((28d / 100 * height) - ((18d / 100 * height))));
...
views.get("listview1").vw.setHeight((int)((75d / 100 * height) - ((27d / 100 * height))));
