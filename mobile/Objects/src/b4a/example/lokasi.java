...
public class lokasi extends Activity implements B4AActivity{
	public static lokasi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.lokasi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (lokasi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.lokasi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.lokasi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (lokasi) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (lokasi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (lokasi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
RDebugUtils.currentModule="lokasi";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create"))
	return (String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime});
RDebugUtils.currentLine=3342336;
 //BA.debugLineNum = 3342336;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=3342338;
 //BA.debugLineNum = 3342338;BA.debugLine="Activity.LoadLayout(\"lokasi\")";
mostCurrent._activity.LoadLayout("lokasi",mostCurrent.activityBA);
RDebugUtils.currentLine=3342339;
 //BA.debugLineNum = 3342339;BA.debugLine="Log(\"http://192.168.100.13/wisatasolsel/mobile/al";
anywheresoftware.b4a.keywords.Common.Log("http://192.168.100.13/wisatasolsel/mobile/all_mark.php?id="+mostCurrent._pencarian_nama._id);
RDebugUtils.currentLine=3342340;
 //BA.debugLineNum = 3342340;BA.debugLine="WebView1.LoadUrl(\"http://192.168.100.13/wisatasol";
mostCurrent._webview1.LoadUrl("http://192.168.100.13/wisatasolsel/mobile/all_mark.php?id="+mostCurrent._pencarian_nama._id);
...
RDebugUtils.currentLine=3538945;
 //BA.debugLineNum = 3538945;BA.debugLine="StartActivity(home)";
...
RDebugUtils.currentLine=3604480;
 //BA.debugLineNum = 3604480;BA.debugLine="Sub Button2_Click";
RDebugUtils.currentLine=3604481;
 //BA.debugLineNum = 3604481;BA.debugLine="StartActivity(pencarian_travel)";
...
RDebugUtils.currentLine=3670016;
 //BA.debugLineNum = 3670016;BA.debugLine="Sub Button3_Click";
RDebugUtils.currentLine=3670017;
 //BA.debugLineNum = 3670017;BA.debugLine="StartActivity(pencarian_nama)";
...
RDebugUtils.currentLine=3735552;
 //BA.debugLineNum = 3735552;BA.debugLine="Sub Button4_Click";
RDebugUtils.currentLine=3735553;
 //BA.debugLineNum = 3735553;BA.debugLine="StartActivity(pencarian_des)";
