...
public class lokasi_trav extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.lokasi_trav");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (lokasi_trav).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.lokasi_trav");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.lokasi_trav", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (lokasi_trav) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (lokasi_trav) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (lokasi_trav) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _travel_lines{
...
RDebugUtils.currentModule="lokasi_trav";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create"))
	return (String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime});
RDebugUtils.currentLine=8847360;
 //BA.debugLineNum = 8847360;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=8847362;
 //BA.debugLineNum = 8847362;BA.debugLine="Activity.LoadLayout(\"lokasi\")";
mostCurrent._activity.LoadLayout("lokasi",mostCurrent.activityBA);
RDebugUtils.currentLine=8847363;
 //BA.debugLineNum = 8847363;BA.debugLine="Log(\"http://192.168.100.13/wisatasolsel/mobile/al";
anywheresoftware.b4a.keywords.Common.Log("http://192.168.100.13/wisatasolsel/mobile/all_mark.php?id="+mostCurrent._pencarian_travel._id);
RDebugUtils.currentLine=8847364;
 //BA.debugLineNum = 8847364;BA.debugLine="WebView1.LoadUrl(\"http://192.168.100.13/wisatasol";
mostCurrent._webview1.LoadUrl("http://192.168.100.13/wisatasolsel/mobile/all_mark.php?id="+mostCurrent._pencarian_travel._id);
