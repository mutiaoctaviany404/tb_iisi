...
public class info_utama implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("info_utama"), "b4a.example.info_utama");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, info_utama.class);
...
public static b4a.example.login _login = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",info_utama.mostCurrent._activity,"addbooking",Debug.moduleToString(b4a.example.addbooking.class),"booking",Debug.moduleToString(b4a.example.booking.class),"Button1",info_utama.mostCurrent._button1,"Button2",info_utama.mostCurrent._button2,"Button3",info_utama.mostCurrent._button3,"Button4",info_utama.mostCurrent._button4,"Button5",info_utama.mostCurrent._button5,"Button7",info_utama.mostCurrent._button7,"DateUtils",info_utama.mostCurrent._dateutils,"galeri_ut",Debug.moduleToString(b4a.example.galeri_ut.class),"home",Debug.moduleToString(b4a.example.home.class),"HttpUtils2Service",info_utama.mostCurrent._httputils2service,"id",info_utama._id,"idmes",info_utama.mostCurrent._idmes,"info_des",Debug.moduleToString(b4a.example.info_des.class),"info_travel",Debug.moduleToString(b4a.example.info_travel.class),"Label3",info_utama.mostCurrent._label3,"Label4",info_utama.mostCurrent._label4,"Label7",info_utama.mostCurrent._label7,"Label8",info_utama.mostCurrent._label8,"lat",info_utama._lat,"ListView1",info_utama.mostCurrent._listview1,"ListView2",info_utama.mostCurrent._listview2,"ListView3",info_utama.mostCurrent._listview3,"lng",info_utama._lng,"login",Debug.moduleToString(b4a.example.login.class),"lokasi",Debug.moduleToString(b4a.example.lokasi.class),"lokasi_des",Debug.moduleToString(b4a.example.lokasi_des.class),"lokasi_trav",Debug.moduleToString(b4a.example.lokasi_trav.class),"lokasi_travel",Debug.moduleToString(b4a.example.lokasi_travel.class),"Main",Debug.moduleToString(b4a.example.main.class),"NAMA",info_utama._nama,"pencarian_des",Debug.moduleToString(b4a.example.pencarian_des.class),"pencarian_nama",Debug.moduleToString(b4a.example.pencarian_nama.class),"pencarian_travel",Debug.moduleToString(b4a.example.pencarian_travel.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}