...
public static b4a.example.login _login = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",home.mostCurrent._activity,"addbooking",Debug.moduleToString(b4a.example.addbooking.class),"booking",Debug.moduleToString(b4a.example.booking.class),"Button1",home.mostCurrent._button1,"Button2",home.mostCurrent._button2,"Button3",home.mostCurrent._button3,"Button4",home.mostCurrent._button4,"DateUtils",home.mostCurrent._dateutils,"galeri_ut",Debug.moduleToString(b4a.example.galeri_ut.class),"HttpUtils2Service",home.mostCurrent._httputils2service,"ImageView1",home.mostCurrent._imageview1,"info_des",Debug.moduleToString(b4a.example.info_des.class),"info_travel",Debug.moduleToString(b4a.example.info_travel.class),"info_utama",Debug.moduleToString(b4a.example.info_utama.class),"login",Debug.moduleToString(b4a.example.login.class),"lokasi",Debug.moduleToString(b4a.example.lokasi.class),"lokasi_des",Debug.moduleToString(b4a.example.lokasi_des.class),"lokasi_trav",Debug.moduleToString(b4a.example.lokasi_trav.class),"lokasi_travel",Debug.moduleToString(b4a.example.lokasi_travel.class),"Main",Debug.moduleToString(b4a.example.main.class),"pencarian_des",Debug.moduleToString(b4a.example.pencarian_des.class),"pencarian_nama",Debug.moduleToString(b4a.example.pencarian_nama.class),"pencarian_travel",Debug.moduleToString(b4a.example.pencarian_travel.class),"Server",home._server,"Starter",Debug.moduleToString(b4a.example.starter.class),"tmSplash",home._tmsplash};
}
}