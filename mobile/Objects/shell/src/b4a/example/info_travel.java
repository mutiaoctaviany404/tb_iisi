...
public class info_travel implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("info_travel"), "b4a.example.info_travel");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, info_travel.class);
        main_subs_0.initializeProcessGlobals();
		return pcBA;
	}
public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _trav = RemoteObject.createImmutable("");
...
public static b4a.example.login _login = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",info_travel.mostCurrent._activity,"addbooking",Debug.moduleToString(b4a.example.addbooking.class),"booking",Debug.moduleToString(b4a.example.booking.class),"Button1",info_travel.mostCurrent._button1,"Button2",info_travel.mostCurrent._button2,"Button3",info_travel.mostCurrent._button3,"Button4",info_travel.mostCurrent._button4,"Button5",info_travel.mostCurrent._button5,"Button6",info_travel.mostCurrent._button6,"Button7",info_travel.mostCurrent._button7,"DateUtils",info_travel.mostCurrent._dateutils,"galeri_ut",Debug.moduleToString(b4a.example.galeri_ut.class),"home",Debug.moduleToString(b4a.example.home.class),"HttpUtils2Service",info_travel.mostCurrent._httputils2service,"id",info_travel._id,"info_des",Debug.moduleToString(b4a.example.info_des.class),"info_utama",Debug.moduleToString(b4a.example.info_utama.class),"Label3",info_travel.mostCurrent._label3,"Label4",info_travel.mostCurrent._label4,"Label7",info_travel.mostCurrent._label7,"Label8",info_travel.mostCurrent._label8,"lat",info_travel._lat,"ListView1",info_travel.mostCurrent._listview1,"ListView2",info_travel.mostCurrent._listview2,"ListView3",info_travel.mostCurrent._listview3,"lng",info_travel._lng,"login",Debug.moduleToString(b4a.example.login.class),"lokasi",Debug.moduleToString(b4a.example.lokasi.class),"lokasi_des",Debug.moduleToString(b4a.example.lokasi_des.class),"lokasi_trav",Debug.moduleToString(b4a.example.lokasi_trav.class),"lokasi_travel",Debug.moduleToString(b4a.example.lokasi_travel.class),"Main",Debug.moduleToString(b4a.example.main.class),"pencarian_des",Debug.moduleToString(b4a.example.pencarian_des.class),"pencarian_nama",Debug.moduleToString(b4a.example.pencarian_nama.class),"pencarian_travel",Debug.moduleToString(b4a.example.pencarian_travel.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"TRAV",info_travel._trav};
}
}