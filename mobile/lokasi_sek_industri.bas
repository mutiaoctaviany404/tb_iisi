...
Sub Process_Globals
	...
	Dim latAsal, lngAsal, latAsal1, lngAsal1,latTujuan, lngTujuan, latHenti, lngHenti, id_industri As String
	Dim id, lat, lng, id_angkot, destination, route_color As String
	Type sekitarangkotind_lines (isi1 As String,isi2 As String,isi3 As String)
...
Sub Activity_Create(FirstTime As Boolean)
	...
	id_industri = info_industri_sek.id
		...
		Select Job.JobName	
			...
			angkotrm_array = parser.NextArray
				For i=0 To angkotrm_array.Size -1
					...
					Dim b As sekitarangkotind_lines
					b.Initialize
...
Sub posisi1
	WebView1.LoadUrl(""&Main.Server&"petaindustri.php?lat="&latTujuan&"&lng="&lngTujuan)
...
Sub ListView1_ItemClick (Position As Int, Value As Object)
	...
	Log(lngHenti)
	Log(latHenti)
	WebView1.LoadUrl(Main.Server&"petaindustri.php?lat="&latTujuan&"&lng="&lngTujuan&"&route_color="&route_color&"&id_angkot="&id_angkot&"&lathenti="&latHenti&"&lnghenti="&lngHenti)
End Sub
