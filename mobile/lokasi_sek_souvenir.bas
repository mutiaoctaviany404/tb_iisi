...
Sub Process_Globals
	...
	Dim latAsal, lngAsal, latAsal1, lngAsal1,latTujuan, lngTujuan, latHenti, lngHenti, idksouv As String
	Dim id, lat, lng, id_angkot, destination, route_color As String
	Type sekitarangkotsouvenir_lines (isi1 As String,isi2 As String,isi3 As String)
		...
		Select Job.JobName	
			...
			angkotrm_array = parser.NextArray
				For i=0 To angkotrm_array.Size -1
					...
					Dim b As sekitarangkotsouvenir_lines
					b.Initialize
...
Sub posisi1
	WebView1.LoadUrl(""&Main.Server&"petasouv.php?lat="&latTujuan&"&lng="&lngTujuan)
