...
Sub Activity_Create(FirstTime As Boolean)
	...
	Label7.Text=pencarian_des.name
	Label8.Text=pencarian_des.price
	...
	Dim Job As HttpJob
	Job.Initialize("Jobcarides", Me)
	Job.PostString("http://192.168.100.13/wisatasolsel/mobile/info_detail.php?id="&pencarian_des.id,"")
End Sub
...
Sub detailNama
	...
	ExecuteRemoteQuery("SELECT*FROM object_point where id_package='"&pencarian_des.id&"' ORDER BY object_point.no_urut ASC ","object")
End Sub
