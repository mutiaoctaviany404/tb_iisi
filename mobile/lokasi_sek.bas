...
Sub Process_Globals
	...
	Dim latAsal, lngAsal, latAsal1, lngAsal1, latTujuan, lngTujuan, latHenti, lngHenti, idres As String
	Dim id, lat, lng, id_angkot, destination, route_color As String
	Type sekitarangkot_lines (isi1 As String,isi2 As String,isi3 As String)
...
Sub Activity_Resume
	latAsal = current_pos.latUser
	lngAsal = current_pos.lngUser
	latAsal = info_utama.lat
	lngAsal = info_utama.lng
End Sub
...
Sub posisi1
	WebView1.LoadUrl(""&Main.Server&"petares.php?lat="&latTujuan&"&lng="&lngTujuan)
...
Sub ListView1_ItemClick (Position As Int, Value As Object)
	...
	Log(lngHenti)
	Log(latHenti)
	WebView1.LoadUrl(Main.Server&"petares.php?lat="&latTujuan&"&lng="&lngTujuan&"&route_color="&route_color&"&id_angkot="&id_angkot&"&lathenti="&latHenti&"&lnghenti="&lngHenti)
End Sub
