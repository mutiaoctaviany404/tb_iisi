...
function initialize(){
  ...
  restaurant_dig = new google.maps.Data();
  restaurant_dig.loadGeoJson('htl.php?id='+id.value);
  restaurant_dig.setMap(map);
  restaurant_dig.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  });
  //zoom peta sesuai digitasi
  var bounds = new google.maps.LatLngBounds();
  restaurant_dig.addListener('addfeature', function(e) {
