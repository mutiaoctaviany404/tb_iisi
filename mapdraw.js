...
function initialize(){
  ...
  tourism_reg = new google.maps.Data();
  tourism_reg.loadGeoJson('tw.php?id='+id.value);
  tourism_reg.setMap(map);
  tourism_reg.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  });
  //zoom peta sesuai digitasi
  var bounds = new google.maps.LatLngBounds();
  tourism_reg.addListener('addfeature', function(e) {
