...
function initialize(){
  ...
  travel_reg = new google.maps.Data();
  travel_reg.loadGeoJson('travel1.php?id='+id.value);
  travel_reg.setMap(map);
  travel_reg.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  ...
  travel_reg.addListener('addfeature', function(e) {
