...
function hideReg() {
  workship_place_dig.setMap(null);
  $('#hider').remove();
...
function initialize(){
  ...
  workship_place_dig = new google.maps.Data();
  workship_place_dig.loadGeoJson('act/travel1.php?id='+id.value);
  workship_place_dig.setMap(map);
  workship_place_dig.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
    });

  var bounds = new google.maps.LatLngBounds();
  workship_place_dig.addListener('addfeature', function(e){
  ...
  google.maps.event.addListener(drawingManager, 'overlaycomplete', function(event){
    ...
    function getCoordinate(){
      ...
      str_input = str_input+''+coor[0]+')))';
      $("#geom").val(str_input);
      console.log("testing get coordinate");
      console.log(str_input);
    }
