...
function initialize(){
  ...
  tempat_wisata_dig = new google.maps.Data();
	tempat_wisata_dig.loadGeoJson('act/tempatwisata.php?id_tempat_wisata='+id_tempat_wisata.value);
	tempat_wisata_dig.setMap(map);
	tempat_wisata_dig.setStyle({
		fillColor: 'red',
		strokeColor: 'red'
	});
  //zoom peta sesuai digitasi
  var bounds = new google.maps.LatLngBounds();
  tempat_wisata_dig.addListener('addfeature', function(e) {
