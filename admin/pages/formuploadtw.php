...
<section id="main-content">
  <section class="wrapper">
      ...
      <div class="row">
        ...
        <!-- <a href="formtw.php" class="btn btn-default"><i class="fa fa-plus"></i> ADD DATA</a> -->
...
?>
        ...
        <table>
          <tbody  style='vertical-align:top;'>
            <td><b>Name</b></td><td>:</td><td><?php echo $name?></td></tr>
            <tr><td><b>Address</b></td><td>:</td><td><?php echo $address ?></td></tr>
            <tr><td><b>district</b></td><td>:</td><td><?php echo $id_district ?></td></tr>
            ...
            <tr><td><b>Location (lat, long)<b> </td><td>: </td><td><?php echo $lat ?> <b>, </b><?php echo $lng ?></td></tr>
          </tbody>
        </table>
