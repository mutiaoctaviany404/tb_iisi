...
where st_contains(district.geom1, workship_place.geom) and workship_place.id='$id'";
...
while($row = pg_fetch_array($hasil)){
  ...
  <div class="col-sm-6"> 
            ...
            <tr>
            <td><b>District<b> </td><td>: </td><td><?php echo $district_name?></td>
            </tr>
            <tr>
            <td><b>Koordinat<b> </td><td>: </td><td><b>Latitude</b> : <?php echo $lat ?> <br><b>Longitude</b> : <?php echo $lng ?></td>
            </tr>
  ...
  $hasil=pg_query($querysearch);
   ...
   while($baris = pg_fetch_array($hasil))
   {
    ...
    ?>
        <image src="../foto/<?php echo $baris['gallery_workship_place']; ?>" style="width:90%;">
      <?php
   }
  ?>
